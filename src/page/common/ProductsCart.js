...
function ProductsCart({ product }) {
  ...
  return (
    <Link to={`/products/${product.id}`}>
      <div className="mb-10 card w-60 h-80 shadow-xl relative group cursor-pointer hover:transform hover:-translate-y-2 hover:shadow-2xl transition-transform duration-300">
